...
VERSION = __import__('dxlfakemcafeeservices').get_version()
RELEASE_NAME = "dxlfakemcafeeservices-python-dist-" + str(VERSION)
CONFIG_RELEASE_NAME = "dxlfakemcafeeservices-python-dist-config-" + str(VERSION)
...
subprocess.check_call(["sphinx-apidoc",
                       ...
                       os.path.join(DIST_PY_FILE_LOCATION, "dxlfakemcafeeservices")])
...
print("\nRemoving dxlfakemcafeeservices.egg-info\n")
remove_tree(os.path.join(DIST_PY_FILE_LOCATION, "dxlfakemcafeeservices.egg-info"))
