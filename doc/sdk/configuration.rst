...
The OpenDXL Fake McAfee Services application requires a set of configuration files to operate.
...
OpenDXL Fake McAfee Services (dxlfakemcafeeservices.config)
---------------------------------------------------------------

    The required ``dxlfakemcafeeservices.config`` file is used to configure the application.
